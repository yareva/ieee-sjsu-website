  ...
  return (
    <footer className="bg-[#1d1d1f] text-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Discord CTA */}
        <div className="bg-[#2563eb] text-white rounded-2xl p-8 mb-12 text-center max-w-2xl mx-auto">
          <h3 className="text-2xl font-heading font-bold mb-3">Join the Community</h3>
          ...
          <a
            ...
            className="inline-block px-8 py-3 bg-white text-[#2563eb] rounded-xl font-semibold hover:scale-105 transition-transform duration-200"
          >
            Join Discord Server
          </a>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8 border-t border-white/10 pt-8">
          ...
          {/* Social Links - no LinkedIn per spec */}
          <div>
